...
coding_speed <- read.delim("data/coding_speed.csv")
raw1980intelligence<- read.csv("data/raw1980intelligence.csv")
...
momintel <- read.csv("C:/Dropbox/SAS/MyFolders/79/SASGen1/momintel.csv", header=FALSE)
names(momintel)<-c("MCASEID","Intel_G1","Intel_G1_SE","HID")
IRT2PL_person_no_cluster <- read.table("C:/Dropbox/Work/Research/Projects/NLSY/AFI/R/MplusG1/IRT2PL_person_no_cluster.csv", quote="\"")
